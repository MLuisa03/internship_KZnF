...
pseudobulk_counts <- read.delim("C:/Users/MLuis/OneDrive/Desktop/UNI/Year 3/INTERNSHIP/pseudobulk.csv", header = TRUE, sep = ";")
...
bulk_counts <- read.delim("C:/Users/MLuis/OneDrive/Desktop/UNI/Year 3/INTERNSHIP/Seq2science output/iMo - LPS vs noLPS/iMye_8bulk_counts.tsv",
...
bulk_tpm <- read.delim("C:/Users/MLuis/OneDrive/Desktop/UNI/Year 3/INTERNSHIP/iMONO_TALPS_Bulk_data.csv", header = TRUE, sep = ";")
...
####  COMPARE LPS / noLPS IN BOTH BULK AND PSEUDOBULK (FROM SUMS)  ####
